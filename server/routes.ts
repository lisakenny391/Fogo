...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  // ⚠️ TEMPORARY DEBUG ENDPOINT WITH HARDCODED CREDENTIALS ⚠️
  // This endpoint tests connectivity with hardcoded values
  // DELETE AFTER TESTING - NOT FOR PRODUCTION
  app.get("/api/debug/hardcoded", async (req, res) => {
